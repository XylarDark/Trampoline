...
**If they ask what it would cost, give the range rather than deflecting.** **$20 to $40 per enrolled client per year, roughly $4,000 to $8,000 for a two-hundred-client site**, against about **$3,000 per client** riding on the four checkpoints. Say plainly that it is a placeholder nobody has paid yet, and that the first two or three sites are free in exchange for their retention-hours data and a reference. Two conditions: do not say it until section 2 has produced their own cost figure, and do not negotiate on the call — "that is the shape of it, and I would rather price it against your numbers than mine" is the whole answer. The derivation and its sources are in [`../business-design.md`](../business-design.md).
